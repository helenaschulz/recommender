...
| `docs/` | [`RESULTS.md`](docs/RESULTS.md) — the measurement ledger — plus [`dataset_findings.md`](docs/dataset_findings.md), the model-selection write-up [`model_selection.md`](docs/model_selection.md), the one-page [`model_cheatsheet.md`](docs/model_cheatsheet.md), the two hand audits [`floor_band_audit.md`](docs/floor_band_audit.md) and [`anchor_set_audit.md`](docs/anchor_set_audit.md), the hand-read samples [`edition_clusters_sample.md`](docs/edition_clusters_sample.md) and [`work_key_punctuation_sample.md`](docs/work_key_punctuation_sample.md), and figures under `docs/img/`. |
