...
L81 and L85 found the same shape twice: **every engine this project has measured is separated
from item-item below the app's anchor floor and indistinguishable above it.** That makes "which
